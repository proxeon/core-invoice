...
License: MIT OR Apache-2.0. Releases: [CHANGELOG.md](CHANGELOG.md). crates.io: [core-invoice 2.0.2](https://crates.io/crates/core-invoice). Git tag **v2.0.2**. crates.io **2.0.1** / **2.0.0** / **1.0.0** remain (not yanked).
